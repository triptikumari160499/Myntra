                    ...
                    <div id="deals">
                        ...
                        <div id="deals1" >
                            ...
                            <div class="card-link-div ">
                                <Button variant="light" class="card-link "><i class="far fa-heart"></i></Button>
                                ...
                                <Button variant="light" style={{ cursor: "pointer" }} onClick={share} class="card-link"><i class="fas fa-share-alt"></i></Button>
                            </div>
                        </div>
